package com.logistic.common.handler;
...
public abstract class AbstractGlobalExceptionHandler {
  ...
  public ResponseEntity<ApiResponse<MethodArgumentTypeMismatchException>> handleMethodArgumentTypeMismatchException(
  ...
  protected ResponseEntity<ApiResponse<BindException>> handleBindException(BindException e) {
    log.error("handleBindException", e);
//    final ApiResponse<BindException> response = ApiResponse.of(ErrorCode.BIND_ERROR, e.getBindingResult());
  ...
  protected ResponseEntity<ApiResponse<HttpRequestMethodNotSupportedException>> handleHttpRequestMethodNotSupportedException(
  ...
  protected ResponseEntity<ApiResponse<Exception>> handleException(Exception e) {
    log.error("handleException", e);
    ErrorCode code = ErrorCode.INTERNAL_SERVER_ERROR;
    final ApiResponse<Exception> response = ApiResponse.fail(code.getCode(), code.getMessage());
